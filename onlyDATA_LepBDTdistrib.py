...
# input file (Data)                                                                                                                                                    
if(period == "data2016"):
    data = TFile.Open("/eos/user/t/tsculac/BigStuff/LegacyProduction_1/Data_2016/AllData/ZZ4lAnalysis.root") # 2016 data                                          
    if(ZZTree):
    ...
    data = TFile.Open("/data3/Higgs/180416/AllData/ZZ4lAnalysis.root") #2018 data
    if(ZZTree):
        tree      = data.Get("ZZTree/candTree")
        treeText  = "ZZTree"
    elif(CRZLTree):
