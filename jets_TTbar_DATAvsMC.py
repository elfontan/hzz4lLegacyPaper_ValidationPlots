...
DIR = "/afs/cern.ch/work/e/elfontan/private/HZZ/HopefullyFinalProduction/CMSSW_10_2_18/src/ZZAnalysis/AnalysisStep/test/hzz4l_ValidationPlots/TTbar_outputDir/"
        ...
        for jet in range(event.JetPt.size()):
                ...
                if len(jet_varDn_list) > 0:
                        for jvar_dn in range(len(jet_varDn_list)):
                                ...
                                #print "jet_varDn_sum", jvar_dn, " = ", jet_varDn_list[jvar_dn]
                        jet_varDn = math.sqrt(jet_varDn_sum)
                        #print "jet_varDn", jet_varDn
                if len(jet_varUp_list) > 0:
                        for jvar_up in range(len(jet_varUp_list)):
                                ...
                                #print "jet_varUp_sum", jvar_up, " = ", jet_varUp_list[jvar_up]
                        jet_varUp = math.sqrt(jet_varUp_sum)
                        #print "jet_varUp", jet_varUp
