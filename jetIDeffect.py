...
for event in tDY:
        ...
        if (event.JetEta.size() > 0 and event.JetPt.at(0) > 30. and event.JetID.at(0) != 0 and event.JetPUID.at(0) != 0):
        ...
        if (event.JetEta.size() > 0 and event.JetJERUp.at(i_up)*(1+event.JetSigma.at(i_up)) > 30. and event.JetID.at(i_up) != 0 and event.JetPUID.at(i_up) != 0):
        ...
        if (event.JetEta.size() > 0 and event.JetJERDown.at(i_dn)*(1-event.JetSigma.at(i_up)) > 30. and event.JetID.at(i_dn) != 0 and event.JetPUID.at(i_dn) != 0):
        ...
        if (event.JetEta.size() > 0 and event.JetPt.at(0) > 30. and event.JetID.at(0) != 0):
        ...
        if (event.JetEta.size() > 0 and event.JetJERUp.at(i_up)*(1+event.JetSigma.at(i_up)) > 30. and event.JetID.at(i_up) != 0):
        ...
        if (event.JetEta.size() > 0 and event.JetJERDown.at(i_dn)*(1-event.JetSigma.at(i_up)) > 30. and event.JetID.at(i_dn) != 0):
        ...
        if (event.JetEta.size() > 0 and event.JetPt.at(0) > 30.):
        ...
        if (event.JetEta.size() > 0 and event.JetJERUp.at(i_up)*(1+event.JetSigma.at(i_up)) > 30.):
        ...
        if (event.JetEta.size() > 0 and event.JetJERDown.at(i_dn)*(1-event.JetSigma.at(i_up)) > 30.):
...
c = ROOT.TCanvas()
DrawRatioPlot(DIR+"leadingJetEta_noID", "Leading jet #eta", "Events/0.2", c, leadingJet_Eta_noID_data, leadingJet_Eta_noID_MC, leadingJet_Eta_noID_MCup, leadingJet_Eta_noID_MCdn, False)
DrawRatioPlot(DIR+"leadingJetEta_jetID", "Leading jet #eta", "Events/0.2", c, leadingJet_Eta_jetID_data, leadingJet_Eta_jetID_MC, leadingJet_Eta_jetID_MCup, leadingJet_Eta_jetID_MCdn, False)
DrawRatioPlot(DIR+"leadingJetEta_PUID", "Leading jet #eta", "Events/0.2", c, leadingJet_Eta_PUID_data, leadingJet_Eta_PUID_MC, leadingJet_Eta_PUID_MCup, leadingJet_Eta_PUID_MCdn, False)
